...
function EnhancedStatsContainer() {
          ...
          {chartData.map((item) => (
            <div key={item.name} className="space-y-1">
              <div className="flex justify-between">
                ...
                <span className="text-sm text-gray-500">{item.score.toFixed(1)}%</span>
              </div>
...
// Simple icons (you can replace with actual icons from your library)
...
export default EnhancedStatsContainer;